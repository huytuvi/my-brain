...
- [x] Viết script `scripts/create_db.py` tạo SQLite `brain.db` với 3 bảng (`knowledge`, `business`, `brand_voice`).
...
- [x] Viết 3 bài đăng mạng xã hội cho Ngày 1 vào file .
- [x] Xây dựng trang Web Dashboard  điều khiển đa cửa sổ và theo dõi Brain Score.